...
public:
	...
	Vec3 ViewAngles; // 0x0030
	char pad_0x003C[0x4]; // 0x003C
	Vec3 ViewAngles2; // 0x0040
	char pad_0x004C[0x14]; // 0x004C
	Vec3 Crosshair_Location; // 0x0060
...
public:
	...
	void SetColorPrimary(BYTE p_R, BYTE p_G, BYTE p_B, BYTE p_A) {
		btPrimaryRed = p_R;
		btPrimaryGreen = p_G;
		btPrimaryBlue = p_B;
		btPrimaryAlpha = p_A;
	}
	void SetColorSecondary(BYTE s_R, BYTE s_G, BYTE s_B, BYTE s_A) {
		btSecondaryRed = s_R;
		btSecondaryGreen = s_G;
		btSecondaryBlue = s_B;
		btSecondaryAlpha = s_A;
	}
}; //Size=0x00AC
...
public:
	...
	char pad_0x0020[0x10]; // 0x0020
	Vec3 Vec3WantedCenterPos; // 0x0030 
	char pad_0x003C[0x4]; // 0x003C
	Vec3 Vec3WantedCenterPos2; // 0x0040 
...
public:
	...
	Vec3 Vec3CentreOfMassOffset; // 0x0020 
	char pad_0x002C[0x4]; // 0x002C
	Vec3 Vec3InertiaMult; // 0x0030 
	char pad_0x003C[0x4]; // 0x003C
...
static std::string get_ped_type_name(BYTE ped_type) {
